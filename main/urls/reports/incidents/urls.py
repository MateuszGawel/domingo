...
urlpatterns = patterns('',
    ...
    url(r'^(?P<inc_id>\d+)/invalidate/$', view.invalidate, name='invalidate'),
    url(r'^(?P<inc_id>\d+)/close/$', view.close, name='close'),
    url(r'^(?P<inc_id>\d+)/reopen/$', view.reopen, name='reopen'),
